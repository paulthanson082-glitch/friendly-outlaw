...
final class GiftCardErrorTests: XCTestCase {
    ...
    // MARK: - Regression: expirationDays=0 is now valid (expires immediately)

    func testZeroExpirationDaysSucceeds() throws {
        let manager = GiftCardManager()
    ...
    func testNegativeExpirationDaysErrorMessageContent() throws {
        ...
        XCTAssertThrowsError(
            ...
            // Message must reflect the wording "greater than or equal to 0".
