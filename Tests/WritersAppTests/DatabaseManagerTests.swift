...
final class DatabaseManagerTests: XCTestCase {
    ...
    func testNonSensitiveFieldsPersistCorrectly() throws {
        ...
        XCTAssertNotNil(retrieved?.temperature, "temperature must be non-nil")
        XCTAssertEqual(retrieved?.temperature ?? 0.0, 0.42, accuracy: 0.001, "temperature must persist in database")
    }
    ...
    func testNonAPIKeyConfigurationFieldsArePersistedCorrectly() throws {
        ...
        XCTAssertNotNil(retrieved?.temperature, "temperature must be non-nil")
        XCTAssertEqual(retrieved?.temperature ?? 0.0, 0.9, accuracy: 0.001, "Temperature must persist")
