...
def call_firecrawl_agent(
    ...
    """
    Send a request to Firecrawl's /agent endpoint and return the parsed
    structured output dict.

    Raises:
        RuntimeError: on HTTP errors or missing 'data' in the response.
    """
...
def render_skill_markdown(data: dict) -> str:
    """Convert the structured agent output into a Claude skill markdown file."""
    lines = []
